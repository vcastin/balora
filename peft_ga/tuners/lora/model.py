...
from peft_ga.import_utils import is_bnb_4bit_available, is_bnb_available
from peft_ga.tuners.tuners_utils import (
    BaseTuner,
    BaseTunerLayer,
...
from peft_ga.utils.merge_utils import dare_linear, dare_ties, magnitude_prune, task_arithmetic, ties
...
class LoraModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        from peft_ga.tuners.adalora import AdaLoraLayer
