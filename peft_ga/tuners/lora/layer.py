...
from peft_ga.tuners.tuners_utils import BaseTunerLayer, check_adapters_to_merge
from peft_ga.utils.integrations import dequantize_module_weight, gather_params_ctx
from peft_ga.utils.other import transpose
...
class LoraLayer(BaseTunerLayer):
    ...
    def lora_ga_init(self, adapter_name):
        ...
        ## debug
        # with open("grad_shape_llama.txt", "a") as f:
        #     f.write("grad_shape " + grad.shape.__str__())
        #     f.write("\n")
        ## end of debug
        ...
        ## debug
        # with open("adapter_shape_llama.txt", "a") as f:
        #     f.write("A_shape " + self.lora_A[adapter_name].weight.data.shape.__str__())
        #     f.write(", ")
        #     f.write("B_shape " + self.lora_B[adapter_name].weight.data.shape.__str__())
        #     f.write("\n")
        ## end of debug
        if not quant_flag:
            weight = weight.data
    ...
    def loftq_init(self, adapter_name):
        from peft_ga.utils.loftq_utils import loftq_init
